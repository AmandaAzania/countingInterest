...
function simpleInterest() {
  ...
  document.getElementById("siOutput-01").innerHTML = "Interest: R" + simpleInt.toFixed(2);
  document.getElementById("siOutput-02").innerHTML = "Total plus interest: R" + amount;
}
